...
※ 회원카드 수령과 관계없이 가입승인 후 모바일 앱/웹 스마트키로 쏘카를 이용하실 수 있습니다.</dd>
					...
					<!-- paginate -->
					<div id="pagination" class="pagination" style="margin-top: 15px; position: absolute; left: 371.5px;"><span class="current prev">&lt;</span><span class="current">1</span><a href="">2</a><a href="" class="next">&gt;</a></div>
					<!-- //paginate -->
				</div>
</div>
</div>		
