...
　택시: 연동 삼성전자 서비스센터 옆 라마다 앙코르 호텔 주차장 (약 7분소요)<br><br>
					...
					<!-- paginate -->
					<div id="pagination" class="pagination" style="margin-top: 15px; position: absolute; left: 371.5px;"><span class="current prev">&lt;</span><span class="current">1</span><a href="">2</a><a href="">3</a><a href="">4</a><a href="" class="next">&gt;</a></div>
					</div>
					<!-- //paginate -->
				</div>
</div>
