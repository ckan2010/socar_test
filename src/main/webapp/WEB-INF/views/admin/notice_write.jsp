					...
					<form name="notice_write" method="post" action="" accept-charset="utf-8" enctype="multipart/form-data">
						...
						<input type="hidden" name="channel" value="www">
							...
							<tr>
								...
								<td>
									<input id="title" type="text" name="title" class="input" value="" style="width:75%">
									<textarea id="contents" cols="" name="contents" rows="15" class="textarea" style="width:95%"></textarea>
								</td>
							</tr>							
							</tbody></table>
							<p class="centerBtn">
